...
public class SovietTroopWithdrawals extends Card {
	...
	public void onEvent(int sp, String[] args) {
		...
		builder.setTitle("Soviet Troops Withdraw from Eastern Europe")
		.setColor(Color.blue);
		if (doable.isEmpty()) {
			builder.addField("No spaces to target!", "Congratulations. You've managed to dodge Soviet Troop Withdrawals. Was it worth losing Eastern Europe?", false);
		}
		else {
	...
	public String getName() {
		return "Soviet Troop Withdrawals";
	}
	...
	public boolean isFormatted(int sp, String[] args) {
		...
		int maxInfRem = 0;
		for (int i=Common.bracket[0]; i<Common.bracket[4]; i++) { //E. Europe
		...
		if (sum!=-5) return false; // up to 4 influence may be removed...
		return true;
	}

	@Override
	public String getDescription() {
		return "Remove 5 Communist Support from Eastern Europe.";
	}
