	...
	public void onCommand(MessageReceivedEvent e, String[] args) {
		...
		//game data
			...
			EmbedBuilder builder = new CardEmbedBuilder()
					...
					.addField("Space Race: " + (GameData.hasT2(0)?StartCommand.emojiID[3]:StartCommand.emojiID[1]) + CardEmbedBuilder.intToEmoji(GameData.getT2(0))
						+(GameData.hasAbility(0, 1)?":mahjong:":"")
						...
						+(GameData.hasAbility(1, 1)?":mahjong:":"")
