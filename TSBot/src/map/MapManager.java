...
public class MapManager {
	...
	public static void initialize() {//literally list every damn country here.
		...
		map.add(new Country(
				...
				"At the Yalta Conference during World War II, Stalin promised to hold free elections in Poland, a promise he reneged on; the communists had almost total control over the country. In 1946, a people's referendum was held on three questions; "
				+ "with the government manipulating the ballots, all three motions in this \"Three Times Yes\" referendum—abolishing the Senate, land reform, and the extension of the Polish border to the Oder-Neisse Line—passed. "
				+ "Polish communism would be continually challenged by various factions, including the Polish Pope John Paul II and the shipyard workers that would eventually coalesce into Solidarity.", 
				new int[] {0,0}
				));
		map.add(new Country(
				"Romania", 
		...
		map.add(new Country(
				...
				+ "and Olof Palme, the Prime Minister with notable anti-apartheid sympathies who was mysteriously murdered in 1986.", 
				new int[] {0,0}
				));
		map.add(new Country(
				"Turkey", 
	...
	public static boolean customSetup(String s) {
		for (int i=0; i<84; i++) {
			...
			MapManager.get(i).influence[0]=us;
			MapManager.get(i).influence[1]=su;
		}
