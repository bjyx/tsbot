...
public class StartCommand extends Command {
	...
	public void onCommand(MessageReceivedEvent e, String[] args) {
		...
		try {
			...
			if (e.getGuild().getEmotesByName("InfluenceA", false).isEmpty()) emojiID[6] = new GuildController(e.getGuild()).createEmote("InfluenceA", Icon.from(new File("./src/images/emoji/InfluenceA.png")), e.getGuild().getPublicRole()).complete().getAsMention();
			else emojiID[6] = e.getGuild().getEmotesByName("InfluenceA", false).get(0).getAsMention();
			if (e.getGuild().getEmotesByName("InfluenceR", false).isEmpty()) emojiID[7] = new GuildController(e.getGuild()).createEmote("InfluenceR", Icon.from(new File("./src/images/emoji/InfluenceR.png")), e.getGuild().getPublicRole()).complete().getAsMention();
			else emojiID[7] = e.getGuild().getEmotesByName("InfluenceR", false).get(0).getAsMention();
			if (e.getGuild().getEmotesByName("InfluenceN", false).isEmpty()) emojiID[8] = new GuildController(e.getGuild()).createEmote("InfluenceN", Icon.from(new File("./src/images/emoji/InfluenceN.png")), e.getGuild().getPublicRole()).complete().getAsMention();
			else emojiID[8] = e.getGuild().getEmotesByName("InfluenceN", false).get(0).getAsMention();
			if (e.getGuild().getEmotesByName("InfluenceAC", false).isEmpty()) emojiID[9] = new GuildController(e.getGuild()).createEmote("InfluenceAC", Icon.from(new File("./src/images/emoji/InfluenceAC.png")), e.getGuild().getPublicRole()).complete().getAsMention();
			else emojiID[9] = e.getGuild().getEmotesByName("InfluenceAC", false).get(0).getAsMention();
			if (e.getGuild().getEmotesByName("InfluenceRC", false).isEmpty()) emojiID[10] = new GuildController(e.getGuild()).createEmote("InfluenceRC", Icon.from(new File("./src/images/emoji/InfluenceRC.png")), e.getGuild().getPublicRole()).complete().getAsMention();
			else emojiID[10] = e.getGuild().getEmotesByName("InfluenceRC", false).get(0).getAsMention();
			if (e.getGuild().getEmotesByName("InfluenceNC", false).isEmpty()) emojiID[11] = new GuildController(e.getGuild()).createEmote("InfluenceNC", Icon.from(new File("./src/images/emoji/InfluenceNC.png")), e.getGuild().getPublicRole()).complete().getAsMention();
			else emojiID[11] = e.getGuild().getEmotesByName("InfluenceNC", false).get(0).getAsMention();
